...
const STATUS_ITEMS = [
  ...
  { status: 'pending', label: '예비품/재고 모듈 (spare_parts)', owner: '비서+웹빌더' },
  { status: 'pending', label: '작업지시 모듈', owner: '웹빌더' },
  { status: 'pending', label: '자산 마스터 페이지 QR 코드', owner: '웹빌더' },
  { status: 'pending', label: 'Discord 서버 구축 + FMS 웹훅 연동', owner: '비서+웹빌더' },
  ...
  { status: 'confirm', label: 'GitHub PAT 보안 교체', owner: 'PAT 갱신 권고' },
];
